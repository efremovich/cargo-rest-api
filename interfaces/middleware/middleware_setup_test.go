...
func Setup() *Dependencies {
	...
	authOA := authorization.NewOauthAuth(conf.KeyConfig, redisService.Client)
	authGateway := authorization.NewAuthGateway(authBasic, authJWT, authOA, dbService.User, dbService.Role)
